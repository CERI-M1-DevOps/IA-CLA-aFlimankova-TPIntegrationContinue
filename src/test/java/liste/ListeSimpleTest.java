...
class ListeSimpleTest {
    ...
    void modifiePremier() {
        ...
        assertEquals(
                "ListeSimple(Noeud(3), Noeud(4), Noeud(1))",
                listeATester.toString()
        );
    ...
    void modifieTous() {
        ...
        assertEquals(
                "ListeSimple(Noeud(4), Noeud(4), Noeud(2), Noeud(4))",
                listeATester.toString()
        );
        assertEquals(4, listeATester.tete.getSuivant().getElement());
    }
    ...
    void supprimePremierEnPositionQuelconque() {
        ...
        assertEquals(
                "ListeSimple(Noeud(4), Noeud(3), Noeud(1))",
                listeATester.toString()
        );
        assertEquals(3, listeATester.getSize());
    }
    ...
    void supprimePremierEnDernierePosition() {
        ...
        listeATester.supprimePremier(1);
        assertEquals(
                "ListeSimple(Noeud(4), Noeud(3), Noeud(2))",
                listeATester.toString()
        );
        assertEquals(3, listeATester.getSize());
    }
    ...
    void inverserListeNbPairDElements() {
        ...
        listeATester.inverser();
        assertEquals(
                "ListeSimple(Noeud(1), Noeud(2), Noeud(3), Noeud(4))",
                listeATester.toString()
        );
    }
    ...
    void inverserListeNbImPairDElements() {
        ...
        listeATester.inverser();
        assertEquals(
                "ListeSimple(Noeud(1), Noeud(2), Noeud(3))",
                listeATester.toString()
        );
    }
    ...
    void echanger2NoeudsQuelconques() {
        ...
        assertEquals(
                "ListeSimple(Noeud(1), Noeud(2), Noeud(3), Noeud(4), Noeud(5))",
                listeATester.toString()
        );
        ...
        assertEquals(
                "ListeSimple(Noeud(1), Noeud(4), Noeud(3), Noeud(2), Noeud(5))",
                listeATester.toString()
        );
    }
    ...
    void echangerLePremierNoeudAvecUnAutre() {
        ...
        assertEquals(
                "ListeSimple(Noeud(4), Noeud(2), Noeud(3), Noeud(1), Noeud(5))",
                listeATester.toString()
        );
    }
